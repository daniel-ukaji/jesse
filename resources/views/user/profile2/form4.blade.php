    ...
    <div class="d-flex align-items-center justify-content-center mt-3">
        <div
            ...
            <form method="POST" action="{{ url('profile', auth()->id()) }}" enctype="multipart/form-data"
                ...
                {{-- country --}}
                <div class="col-md-12">
                    <label for="country" class="form-label fw-bold"> What country do you reside in? <b
                            class="text-danger">*</b></label>
                ...
                <div class="col-md-6">
                    <label for="country" class="form-label fw-bold">State of residence?<b
                            class="text-danger">*</b></label>
                ...
                <div class="col-md-6">
                    <label for="city" class="form-label fw-bold">What is your home city?</label>
